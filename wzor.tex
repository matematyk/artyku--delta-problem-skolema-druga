...
Wiele matematycznych problemów ma bardzo proste sformułowanie, ale ich istota dotyka głębokiej matematyki. Przykładem takiego problemu jest tytułowy problem Skolema. Sformułowanie wydaje się bliskie informatyce teoretycznej zainteresowany Czytelnik znający tzw. problem stopu, może zauważyć tutaj analogię. Techniki służące do rozwiązania problemu podchodzą jednak nie z informatyki teoretycznej, a z algebry. Pewne rozwiązanie przy pomocy technik wymagałoby istotnych postępów w tej dziedzinie.
...
Na pierwszy rzut oka problem nie jest łatwy do rozstrzygnięcia. Wypisując kolejne wyrazy, możemy wysnuć hipotezę, że owy ciąg również poza pierwszym nie ma wyrazu zerowego. Problem można sformułować w ogólności dla większej ilości równań. W tym artykule postaram się pokazać, że za rozwiązaniem nawet dla prostych równań za rozwiązaniem stoi ciekawa matematyka. 
...
Okazuje się, że już dla równań rzędu $2$ rozwiązanie nie jest trywialne. W artykule postaram się przedstawić intuicje stojące za ową nietrywialnością. Bardzo przydatna będzie, znany zapewne niektórym Czytelnikom, własność ciągów rekurencyjnych.
...
Dla zainteresowanego Czytelnika znającego podstawowe narzędzia z algebry liniowej to twierdzenie nie jest to trudne do udowodnienia. 
