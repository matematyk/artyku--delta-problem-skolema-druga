...
Mimo, że to pytanie wydaje się proste, to jego rozwiązanie wymaga wprowadzenia pomysłowych norm mierzących wielkość liczb (innych niż wartość bezwzględna danej liczby) i opierających się na ideałach pierwszych w ciele liczb algebraicznych. Jest to bardzo ciekawa technika, ale opowiedzenie o niej zajęłoby przynajmniej kilka stron w Delcie. Zainteresowanych Czyteników odsyłamy do ... (TODO)
